...
const illegalAttributeNameCache: Record<any, boolean> = {}
const validatedAttributeNameCache: Record<any, boolean> = {}
...
class PropertyInfoRecord {
  public acceptsBooleans: boolean
  constructor(
    public propertyName: string,
    public type: PropertyType,
    public mustUseProperty: boolean,
    public attributeName: string,
    public attributeNamespace: string | null,
    public sanitizeURL: boolean,
  ) {
